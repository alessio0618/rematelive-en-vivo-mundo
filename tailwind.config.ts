	...
	theme: {
		...
		extend: {
			colors: {
				...
				// RemateLive brand colors
				'rl-blue': 'rgb(var(--rl-blue))',
				'rl-yellow': 'rgb(var(--rl-yellow))',
				// Live streaming colors
				'live-red': 'rgb(var(--live-red))',
        ...
        'border-pulse': 'border-pulse 1.5s infinite cubic-bezier(0.66, 0, 0, 1)',
			}
		}
	},
